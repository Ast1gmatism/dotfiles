...
hl.config({
    misc = {    -- Set to 0 or 1 to disable the anime mascot wallpapers
...
-- Вычисляет целевой стол для циклического переключения
-- и возвращает его в виде строки (как любит hl.dsp)
